      ...
      messages: [
        {
          ...
          content: 
            ...
            "   - dueDate: Specific due date in YYYY-MM-DD format, or relative date like 'tomorrow', 'next week', etc.\n" +
            "   - category: Must be one of 'work', 'personal', or 'urgent'\n" +
            "   - priority: Must be one of 'high', 'medium', or 'low'\n" +
            "   - estimatedMinutes: Estimated time to complete the task in minutes (if specified)\n" +
            "   - location: Where the task needs to be performed (if specified)\n" +
            "   - people: Array of names of people involved (if specified)\n" +
            "   - recurring: Boolean indicating if this is a recurring task\n" +
